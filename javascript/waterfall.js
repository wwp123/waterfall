...
var addHtml = function(){
	...
	var html = '';
	//if(screen.width>640){
		$.get('https://wwp123.github.io/waterfall/javascript/waterfall2.json',function(data){
...
var getData3 = function(){ 
	$.ajax({
			async: false,
			type : "GET",
			url : 'https://wwp123.github.io/waterfall/javascript/waterfall3.json',
...
var waterFall = function(id,scrollObj,flag){
		...
		$(scrollObj).scroll(function(){
			...
			if(maxTop<$(scrollObj).height()+$(document).scrollTop()){
				...
				var jsonsrc = 'https://wwp123.github.io/waterfall/javascript/' + id + '.json';
