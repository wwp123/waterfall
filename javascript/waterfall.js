...
var addHtml = function(){
	...
	var html = '';
	//if(screen.width>640){
		$.get('https://github.com/wwp123/waterfall/blob/master/javascript/waterfall2.json',function(data){
...
var getData3 = function(){ 
	$.ajax({
			async: false,
			type : "GET",
			url : 'https://github.com/wwp123/waterfall/blob/master/javascript/waterfall3.json',
