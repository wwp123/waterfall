...
(function($) {
	...
	$.Poshytip = function(elm, options) {
		...
		this.$tip = $(['<div class="',this.opts.className,'">',
						'<div class="hover-dropdown-box-wrapper">',
							'<div class="user-intro">',
								'<div class="introhead clearfix">',
									'<a class="left"><img class="user-photo s4" src="https://31.media.tumblr.com/avatar_74db7708aa09_128.png"alt=""></a>',
									'<p>马甲</p>',
									'<p>001596</p>',
	...
	$.Poshytip.prototype = {
		...
		refresh: function(async) {
			...
			if (async && this.opts.refreshAniDuration) {
				...
				this.$tip.css({left: this.pos.l-60, top: this.pos.t});
			}
		},
		...
		calcPos: function() {
			...
			switch (this.opts.alignY) {
				...
				default: // 'top' || 'inner-bottom'
					...
					if (!pos.arrow || this.opts.alignTo == 'cursor') {
					    pos.arrow = 'bottom';
						$(this.$tip).addClass('down');	
					}
					if (this.opts.keepInViewport && pos.t < win.t) {
						pos.t = yB + this.opts.offsetY;
						if (pos.arrow == 'bottom')
							pos.arrow = 'top';
							$(this.$tip).removeClass('down');	
					}
			}
			this.pos = pos;
		}
	...
	$.fn.poshytip.defaults = {
		...
		className:		'hover-dropdown-box',	// class for the tips
